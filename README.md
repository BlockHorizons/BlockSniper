...
If you do decide to use a development version to benefit from the latest features, here's how:
 - Click the Poggit-CI button below this segment.
 - Download a phar file from the latest development build.
...
The explanation of every setting in the settings.yml can be found in the in-game configuration menu accessed using /blocksniper menu. It is highly recommended to use this, rather than editing the configuration directly. If you do prefer editing the configuration file directly, please do so when the server is _stopped_.