...
The explanation of every setting in the settings.yml can be found in the in-game configuration menu accessed using /blocksniper menu. It is highly recommended to use this, instead of editing the configuration directly.
