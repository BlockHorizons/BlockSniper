...
class GlobalBrushMenuWindow extends Window {
	...
	public function process(): void {
		$this->data = [
			"type" => "form",
			"title" => Translation::get(Translation::UI_GLOBAL_BRUSH_MENU_TITLE),
			"content" => Translation::get(Translation::UI_GLOBAL_BRUSH_MENU_SUBTITLE),
			"buttons" => [
				[
					"text" => Translation::get(Translation::UI_GLOBAL_BRUSH_MENU_CREATE),
					"image" => [
						"type" => "url",
				...
				[
					"text" => Translation::get(Translation::UI_GLOBAL_BRUSH_MENU_DELETE),
					"image" => [
						"type" => "url",
				...
				[
					"text" => Translation::get(Translation::UI_GLOBAL_BRUSH_MENU_SELECT),
					"image" => [
						"type" => "url",
				...
				[
					"text" => Translation::get(Translation::UI_GLOBAL_BRUSH_MENU_LIST),
					"image" => [
						"type" => "url",
				...
				[
					"text" => Translation::get(Translation::UI_GLOBAL_BRUSH_MENU_EXIT),
					"image" => [
						"type" => "url",
						"data" => "http://www.pngmart.com/files/3/Red-Cross-Transparent-PNG.png"
					]
